...
class TestFileCommUtilities(unittest.TestCase):
    ...
    def test_create_directory(self):
        ...
        communication_tests.FileSystem.create_directory(TestFileCommUtilities.dir_name)
    ...
    def test_remove_file(self):
        ...
        # call function to be checked
        communication_tests.FileSystem.remove(TestFileCommUtilities.file_name)
    ...
    def test_remove_empty_dir(self):
        ...
        # call function to be checked
        communication_tests.FileSystem.remove(TestFileCommUtilities.dir_name)
    ...
    def test_remove_full_dir(self):
        ...
        communication_tests.FileSystem.remove_all(TestFileCommUtilities.dir_name)
    ...
    def test_exists_file(self):
        # call function to be checked
        self.assertFalse(communication_tests.FileSystem.exists(TestFileCommUtilities.file_name))
        ...
        # call function to be checked
        self.assertTrue(communication_tests.FileSystem.exists(TestFileCommUtilities.file_name))

    def test_exists_directory(self):
        # call function to be checked
        self.assertFalse(communication_tests.FileSystem.exists(TestFileCommUtilities.dir_name))

        # prepare test
        os.mkdir(TestFileCommUtilities.dir_name)

        # call function to be checked
        self.assertTrue(communication_tests.FileSystem.exists(TestFileCommUtilities.dir_name))

    def test_exists_file_in_directory(self):
        # call function to be checked
        self.assertFalse(communication_tests.FileSystem.exists(TestFileCommUtilities.file_in_dir_name))
        ...
        # call function to be checked
        self.assertTrue(communication_tests.FileSystem.exists(TestFileCommUtilities.file_in_dir_name))
    ...
    def test_rename(self):
        ...
        # call function to be checked
        communication_tests.FileSystem.rename(TestFileCommUtilities.file_name, new_file_name)
